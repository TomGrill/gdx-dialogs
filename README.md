...
```gradle
compile "de.tomgrill.gdxdialogs:gdx-dialogs-core:1.1.1"
```
...
```gradle
compile "de.tomgrill.gdxdialogs:gdx-dialogs-android:1.1.1"
```
...
```gradle
compile "de.tomgrill.gdxdialogs:gdx-dialogs-ios:1.1.1"
```
